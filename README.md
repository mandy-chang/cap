...
Visit out FAQ and help menu on our app. (Or ask our chatbot!)
...
### 2. Clone repository:
```
git clone https://github.com/mandy-chang/cap
cd cap
```
...
* `QUOTE_SERVICE_BASE_URL` the base path to the asset quote provider. This service is used to get updated quotes for tradeable assets (stocks, bonds, mutual funds, cryptocurrencies and commodities). 
